...
<?php
error_reporting(0);
$connection=mysqli_connect('localhost','dcme','dcme030') or die ("<html><script language='JavaScript'>alert('Unable to connect to database! Please try again later.'),history.go(-1)</script></html>");

...
if(isset($_POST['predict']))
{
	...
	$branch=$_POST['branchname'];
      $op="SELECT * from diploma where ('$rank'<=rank and caste='$caste' and district='$district' and branchname='$branch')";
       if($op)
      {
	$query="SELECT * from diploma where ('$rank'<=rank and caste='$caste' and district='$district' and branchname='$branch')";

...
if(isset($_POST['predict']))
{
	...
	$query="SELECT * from btech where ('$rank'<=rank and gender='$gender' and caste='$caste'and district='$district' and branchname='$branch' and region='$region' and collegetype='$collegetype') order by rank";
